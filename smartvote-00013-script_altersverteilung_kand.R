...
#
# Skript zur Visualisierung der Altersverteilung Kandidierende und Gewaehlte
#
...
mean_age_elected <- subset(yob_cand_data, Gewaehlt == 'Ja', drop = TRUE)
...
# --- visualize
age_distribution_cand <- ggplot(yob_cand_data, aes(age, fill = Gewaehlt)) +
    ...
    ggtitle(wrapper(paste0("Altersverteilung aller Kandidierenden und der gewaehlten Kandidierenden"))) +
