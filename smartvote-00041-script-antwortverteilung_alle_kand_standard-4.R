# ==============================================================================
# smartvote-00041-script-antwortverteilung_alle_kand_standard-4.R
#
# Skript zur Visualisierung der Antwortverteilung alle Kandidierende - Fragetyp Standard-4
# 
